...
PARENT = HERE.parent
# Prefer the local package in this repo; only append the parent as a fallback.
if str(PARENT) not in sys.path:
    sys.path.append(str(PARENT))

# Ensure data dir points to repo ./data by default BEFORE importing config
try:
    os.environ.setdefault('PROJECTSEARCHBAR_DATA_DIR', str((HERE / 'data').resolve()))
except Exception:
    pass
...
def main() -> None:
    # Data dir override already set before imports; nothing else to do here
